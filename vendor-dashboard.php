...
<main>
    <section class="business-dashboard-v2">
        <aside class="business-sidebar">
            <a class="business-sidebar-brand" href="index.php">
            Wedding Za
            <br>
            <em>
            Business
            ...
            <nav>
                ...
                <a href="vendor.php?id=amber-courtyard">
                Public profile
                </a>
        ...
        <div class="business-dashboard-main">
            <header class="business-dashboard-head" id="overview">
                <div>
                    <span class="eyebrow">
                    BUSINESS WORKSPACE
                    </span>
                ...
                <a class="pill-btn wine" href="vendor.php?id=amber-courtyard">
                View public profile ↗
                </a>
            </header>
            ...
            <section class="business-panel" id="profile">
                ...
                <div class="profile-quality-grid">
                    <div class="done">
                        ...
                        <small>
                        Name, city, category, starting price
                        </small>
                    </div>
                    <div class="done">
                        <span>
                    ...
                    <div>
                        ...
                        <small>
                        Add more occasion-specific proof
                        </small>
                    </div>
                    <div>
                        <span>
                        ...
                        <small>
                        Add cancellation and travel terms
                        </small>
                    </div>
                </div>
            </section>
            <section class="business-panel">
                ...
                This workspace now has role-aware PHP session access. The next backend phase can replace demo KPIs and enquiry rows with MySQL records without changing the page structure.
                </p>
            </section>
        </div>
    </section>

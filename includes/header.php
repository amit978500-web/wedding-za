    ...
    <body data-page="<?=h($pageKey)?>
        ...
        <header class="vision-header" id="siteHeader">
            <div class="container vision-nav">
                <a class="vision-brand" href="index.php" aria-label="Wedding Za home">
                <span>
                W
                </span>
                <b>
                ...
                <nav class="vision-nav-links" aria-label="Primary navigation">
                    <a<?=wz_active('vendors.php')?>
                    href="vendors.php">Vendors
                    </a>
                    <a<?=wz_active('inspiration.php')?>
                    href="inspiration.php">Ideas
                    </a>
                    <a<?=wz_active('real-weddings.php')?>
                    href="real-weddings.php">Celebrations
                    </a>
                    <a<?=wz_active('blog.php')?>
                    href="blog.php">Journal
                    </a>
                </nav>
                <div class="vision-nav-actions">
                    <button class="vision-discover" type="button" data-discovery-open>
                    Plan an event
                    <span>
                    ↗
                    </span>
                    </button>
                    <a class="vision-heart" href="shortlist.php" aria-label="Open shortlist">
                    ♡
                    <b id="shortlistCount">
                    0
                    </b>
                    </a>
                    <button class="vision-menu-btn" id="menuToggle" type="button" aria-expanded="false" aria-controls="mobileMenu">
                    <span>
                    </span>
                    <span>
                    </span>
        ...
        <div class="vision-menu" id="mobileMenu" aria-hidden="true">
            <div class="vision-menu-bg" aria-hidden="true">
            </div>
        ...
        <div class="discovery-panel" id="discoveryPanel" aria-hidden="true">
            <button class="discovery-backdrop" type="button" data-discovery-close aria-label="Close vendor finder">
            </button>
            <div class="discovery-dialog" role="dialog" aria-modal="true" aria-label="Find event vendors">
                <div class="discovery-top">
                    ...
                    <button type="button" data-discovery-close>
                    Close ×
                    </button>
                </div>
